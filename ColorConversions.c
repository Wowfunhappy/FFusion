...
static FASTCALL void Y420_10toY422_8_sse2(AVPicture *picture, UInt8 *o, long outRB, int width, int height)
{
...
// Original: https://github.com/lemenkov/libyuv/blob/main/source/convert_from.cc
static FASTCALL void Y420_10toY422_8(AVPicture *picture, UInt8 *o, long outRB, int width, int height)
{
	UInt16	*yc = (UInt16*)picture->data[0], *u = (UInt16*)picture->data[1], *v = (UInt16*)picture->data[2];
	int		rY = picture->linesize[0]/2, rUV = picture->linesize[1]/2;
	int		halfheight = height >> 1, halfwidth = width >> 1;
