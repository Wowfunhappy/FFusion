...
#define FFMPEG_CONFIGURATION "cc=/opt/local/bin/clang-mp-9.0 --disable-amd3dnow --disable-doc --disable-encoders --disable-ffprobe --disable-ffserver --disable-muxers --disable-network --disable-avfilter --disable-avdevice --disable-ffmpeg --disable-ffplay --disable-iconv --enable-swscale --enable-libvpx --enable-libde265 --enable-decoder=libde265 --enable-gpl --target-os=darwin --extra-ldflags='-arch i386 -L/opt/local/lib' --extra-cflags='-I/opt/local/include -mmacosx-version-min=10.6 -Dattribute_deprecated= -fvisibility=hidden -w -arch i386'"
...
#define CONFIG_LIBDE265_DECODER 1
...
#define CONFIG_FIELDSHIFT_FILTER 1
