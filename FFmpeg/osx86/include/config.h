...
#define FFMPEG_CONFIGURATION "--extra-ldflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.6.8 -Dattribute_deprecated= -fvisibility=hidden -w -arch i386' --cpu=core2 --extra-cflags='-arch i386 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.6.8 -Dattribute_deprecated= -fvisibility=hidden -w -fstrict-aliasing -mdynamic-no-pic ' --cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --disable-amd3dnow --disable-doc --disable-encoders --disable-ffserver --disable-muxers --disable-network --target-os=darwin --enable-opencl --disable-avfilter --disable-iconv"
