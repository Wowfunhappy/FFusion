...
#define FFMPEG_CONFIGURATION "--extra-ldflags='-isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6.8 -Dattribute_deprecated= -fvisibility=hidden -w -arch i386' --cpu=core2 --extra-cflags='-arch i386 -isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6.8 -Dattribute_deprecated= -fvisibility=hidden -w -fstrict-aliasing -mdynamic-no-pic ' --cc=/opt/local/bin/clang-mp-9.0 --disable-amd3dnow --disable-doc --disable-encoders --disable-videotoolbox --enable-ffprobe --disable-ffserver --enable-muxers --disable-network --enable-libvpx --extra-cflags=-I/opt/local/include --extra-ldflags=-L/opt/local/lib --enable-swscale --enable-avfilter --disable-avdevice --enable-ffmpeg --disable-ffplay --disable-iconv --target-os=darwin"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "clang version 9.0.1"
