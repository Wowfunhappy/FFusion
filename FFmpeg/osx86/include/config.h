...
#define FFMPEG_CONFIGURATION "cc=/opt/local/bin/clang-mp-9.0 --disable-doc --disable-programs --disable-network --disable-avfilter --disable-avdevice --disable-swscale --disable-iconv --disable-everything --enable-decoder=vp9 --enable-decoder=libvpx_vp9 --enable-decoder=hevc --enable-decoder=libdav1d --enable-parser=vp9 --enable-parser=hevc --enable-parser=av1 --enable-libvpx --enable-libdav1d --enable-gpl --target-os=darwin --extra-ldflags='-arch i386 -L/opt/local/lib' --extra-cflags='-I/opt/local/include -mmacosx-version-min=10.6 -Dattribute_deprecated= -fvisibility=hidden -w -arch i386'"
