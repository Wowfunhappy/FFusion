...
#define FFMPEG_CONFIGURATION "cc=/opt/local/bin/clang-mp-18 --disable-doc --disable-programs --disable-network --disable-avfilter --disable-avdevice --disable-swscale --disable-iconv --disable-everything --enable-decoders --enable-parsers --enable-libdav1d --target-os=darwin --disable-debug --enable-fast-unaligned --disable-safe-bitstream-reader --extra-ldflags='-arch i386 -L/opt/local/lib -flto=thin' --extra-cflags='-I/opt/local/include -mmacosx-version-min=10.6 -Dattribute_deprecated= -fvisibility=hidden -w -arch i386 -Ofast -fomit-frame-pointer -fno-stack-protector -flto=thin' --extra-libs=-ldav1d --enable-lto"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "clang version 18.1.8"
